...
#line default
    public sealed class LexScan : sym, java_cup.runtime.Scanner
    {
        ...
        internal bool useRowMap =
            Options.gen_method == Options.PACK || Options.gen_method == Options.TABLE;
...
#line 558 "LexScan.flex"
                            return symbol(
                                CHAR,
                                (char)
                                    Integer.parseInt(yytext().Substring(1, yytext().Length - 1), 8)
                            );
#line default
                        }
                        break;
...
#line 556 "LexScan.flex"
                            return symbol(
                                CHAR,
                                (char)
                                    Integer.parseInt(yytext().Substring(2, yytext().Length - 2), 16)
                            );
#line default
                        }
                        break;
...
#line 527 "LexScan.flex"
                            throw new ScannerException(
                                file,
                                ErrorMessages.EOL_IN_CHARCLASS,
                                yyline,
                                yycolumn
                            );
#line default
...
#line 312 "LexScan.flex"
                            ...
                            if (eofVal == null)
                                eofVal =
                                    "return new java_cup.runtime.Symbol(" + cupSymbol + ".EOF);";
                            if (!Options.jlex)
                                eofclose = true;
...
#line 537 "LexScan.flex"
                            throw new ScannerException(
                                file,
                                ErrorMessages.UNTERMINATED_STR,
                                yyline,
                                yycolumn
                            );
#line default
...
#line 474 "LexScan.flex"
                            yybegin(REPEATEXP);
                            return symbol(REPEAT, int.Parse(yytext().Trim().Substring(1).Trim()));
#line default
                        }
                        break;
                    case 47:
