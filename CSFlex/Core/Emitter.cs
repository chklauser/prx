...
sealed public class Emitter {
  ...
  private void emitHeader() {
    println("/* The following code was generated by CSFlex "+GeneratorCore.Version+" */");
    println("");
  }
  ...
  private void emitClassName() {
    if (!endsWithJavadoc(scanner.userCode)) {
      ...
      println(" * <a href=\"http://www.jflex.de/\">JFlex</a>, version "+GeneratorCore.Version);
  ...
  private void emitActions() {
    ...
    IEnumerable actions = actionTable.Keys
      .Cast<Action>()
