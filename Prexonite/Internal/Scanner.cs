...
//-----------------------------------------------------------------------------------
    [NoDebug()]
    internal partial class Scanner : IDisposable,
                                     IScanner
    {
        ...
        internal Scanner(Buffer buffer, string location)
            : this(buffer)
        {
            file = location;
        }
        ...
        internal Scanner(Stream s, string location)
            : this(s)
        {
            file = location;
        }
            ...
            if (ch == 0xEF)
            {
                ...
                if (ch1 != 0xBB || ch2 != 0xBF)
                {
                    throw new FatalError(
                        String.Format("illegal byte order mark: EF {0,2:X} {1,2:X}", ch1, ch2));
                }
