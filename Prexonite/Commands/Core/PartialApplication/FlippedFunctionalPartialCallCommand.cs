...
namespace Prexonite.Commands.Core.PartialApplication
{
    public class FlippedFunctionalPartialCallCommand : PCommand, ICilExtension
    {
        ...
        private static readonly FlippedFunctionalPartialCallCommand _instance = new FlippedFunctionalPartialCallCommand();
            ...
            get {
                return _functionPartialCallCtorCache ??
                       (_functionPartialCallCtorCache =
                        typeof (FlippedFunctionalPartialCall).GetConstructor(new[] {typeof (PValue), typeof (PValue[])}));
            }
        }
