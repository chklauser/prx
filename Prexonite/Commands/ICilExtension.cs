...
namespace Prexonite.Commands
{
    ...
    public interface ICilExtension
    {
        ...
        /// <para>Returning true means that the CIL extension can provide a CIL implementation for the set of arguments at hand. In that case the CIL compiler may subsequently call <see cref="Implement"/> with the same set of arguments.</para>
        /// </summary>
        ...
        /// <summary>
        /// Implements the CIL extension in CIL for the supplied arguments. The CIL compiler guarantees to always first call <see cref="ValidateArguments"/> in order to establish whether the extension can actually implement a particular call.
        ...
        /// <param name="staticArgv">The suffix of compile-time constant arguments, starting after the last dynamic (not compile-time constant) argument. An empty array means that there were no compile-time constant arguments at the end.</param>
        /// <param name="dynamicArgc">The number of dynamic arguments preceding the supplied static arguments. The total number of arguments is determined by <code>(staticArgv.Length + dynamicArgc)</code></param>
        void Implement(CompilerState state, Instruction ins,  CompileTimeValue[] staticArgv, int dynamicArgc);
    ...
    public struct CompileTimeValue
    {
        ...
        {
            value = null;
            return Interpretation == CompileTimeInterpretation.String && (value = Value as string) != null;
        }
        ...
        {
            commandAlias = null;
            return Interpretation == CompileTimeInterpretation.CommandReference && (commandAlias = Value as string) != null;
        }
        ...
        {
            functionId = null;
            return Interpretation == CompileTimeInterpretation.FunctionReference && (functionId = Value as string) != null;
        }
        ...
        public bool TryGetLocalVariableReference(out string localVariableId)
        {
            ...
            return Interpretation == CompileTimeInterpretation.LocalVariableReference && (localVariableId = Value as string) != null;
        }
        ...
        public bool TryGetGlobalVariableReference(out string globalVariableId)
        {
            ...
            return Interpretation == CompileTimeInterpretation.GlobalVariableReference && (globalVariableId = Value as string) != null;
        }
        ...
        public static bool TryParse(Instruction instruction, IDictionary<int,string > localVariableMapping, out CompileTimeValue compileTimeValue)
        {
        ...
        public static CompileTimeValue[] ParseSequenceReverse(IList<Instruction> instructions, IDictionary<int,string > localVariableMapping, int offset)
        {
            var compileTimeValues = new LinkedList<CompileTimeValue>();
            CompileTimeValue compileTimeValue;
            while (0 <= offset && TryParse(instructions[offset--], localVariableMapping, out compileTimeValue))
