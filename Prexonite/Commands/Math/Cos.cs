...
{
    public class Cos : PCommand, ICilCompilerAware
    {
        #region Singleton
        ...
        private static readonly Cos _instance = new Cos();
        ...
        private static readonly MethodInfo RunStaticallyMethod =
            typeof(Cos).GetMethod("RunStatically", new Type[] { typeof(PValue), typeof(StackContext) });
