...
{
    public class Sqrt : PCommand, ICilCompilerAware
    {
        #region Singleton
        ...
        private static readonly Sqrt _instance = new Sqrt();

        public static Sqrt Instance
        {
        ...
        public static PValue RunStatically(StackContext sctx, PValue[] args)
        {
            ...
            if (args.Length < 1)
                throw new PrexoniteException("Sqrt requires at least one argument.");
        ...
        private static readonly MethodInfo RunStaticallyMethod =
            typeof(Sqrt).GetMethod("RunStatically", new Type[] { typeof(PValue), typeof(StackContext) });
