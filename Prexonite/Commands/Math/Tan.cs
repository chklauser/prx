...
{
    public class Tan : PCommand, ICilCompilerAware
    {
        #region Singleton
        ...
        public static PValue RunStatically(StackContext sctx, PValue[] args)
        {
            ...
            if (args.Length < 1)
                throw new PrexoniteException("Tan requires at least one argument.");
        ...
        private static readonly MethodInfo RunStaticallyMethod =
            typeof(Tan).GetMethod("RunStatically", new Type[] { typeof(PValue), typeof(StackContext) });
